...
Prefer the split preview/apply tools for routine authoring. This compatibility facade runs preview by default and applies only when mode is 'apply' or apply is true.";
        ...
        static object BuildImportSchema(bool includeMode)
        {
            var properties = new Dictionary<string, object>
            {
                ...
                ["frameWidth"] = new { type = "integer", description = "Frame width in imported Unity texture pixels. Use preview diagnostics if source PNG dimensions differ from imported texture dimensions." },
                ["frameHeight"] = new { type = "integer", description = "Frame height in imported Unity texture pixels. Use preview diagnostics if source PNG dimensions differ from imported texture dimensions." },
        ...
        static object BuildImportCompactData(object data)
        {
            ...
            return new
            {
                ...
                requestedFrame = root["requestedFrame"],
