...
Returns:
    Dictionary with results ('success', 'message', 'data'). Read defaults to a preview slice; request full=true for the complete script.";
        ...
        [McpTool("Unity.ManageScript", Description, Title, Groups = new string[] { "core", "scripting" }, EnabledByDefault = true)]
        public static object HandleCommand(JObject @params)
        {
            ...
            switch (action)
            {
                ...
                case "edit":
                    Debug.LogWarning("Unity.ManageScript.edit is deprecated; prefer apply_text_edits. Serving structured edit for backward compatibility.");
