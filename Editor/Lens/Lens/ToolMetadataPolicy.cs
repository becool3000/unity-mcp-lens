...
namespace Becool.UnityMcpLens.Editor.Lens
{
    static class ToolMetadataPolicy
    {
        ...
        static readonly HashSet<string> k_ReadOnlyTools = new(StringComparer.OrdinalIgnoreCase)
        {
            ...
            NormalizeToolName("Unity.Editor.DetectNativeModals"),
            NormalizeToolName("Unity.Editor.DetectFrozenEditor"),
            ...
            NormalizeToolName("Unity.Font.PreviewImportAndBindUiFont"),
            NormalizeToolName("Unity.Asset.PreviewCreateOrUpdateScriptableObject"),
            NormalizeToolName("Unity.UI.PreviewEnsureHierarchy"),
            NormalizeToolName("Unity.UI.PreviewLayoutProperties"),
            NormalizeToolName("Unity.UI.PreviewEnsureButton"),
            NormalizeToolName("Unity.UI.VerifyScreenLayout"),
            NormalizeToolName("Unity.UI.VisualTextAudit"),
            ...
            NormalizeToolName("Unity.Scene.PreviewBindUnityEvent"),
            NormalizeToolName("Unity.Scene.PreviewSaveAndReadback"),
        ...
        static readonly HashSet<string> k_MutatingTools = new(StringComparer.OrdinalIgnoreCase)
        {
            ...
            NormalizeToolName("Unity.Batch.ExecuteWorkflow"),
            NormalizeToolName("Unity.Editor.ResolveSceneReloadPrompt"),
            NormalizeToolName("Unity.Editor.RecoverFrozenEditor"),
            NormalizeToolName("Unity.Font.ApplyImportAndBindUiFont"),
            NormalizeToolName("Unity.Asset.ApplyCreateOrUpdateScriptableObject"),
            ...
            NormalizeToolName("Unity.Scene.ApplyBindUnityEvent"),
            NormalizeToolName("Unity.Scene.ApplySaveAndReadback"),
            ...
            NormalizeToolName("Unity.UI.ApplyEnsureButton"),
            NormalizeToolName("Unity.PlayMode.PointerInputSmoke"),
            NormalizeToolName("Unity.PlayMode.VerifyPaintSurfaceInteraction"),
