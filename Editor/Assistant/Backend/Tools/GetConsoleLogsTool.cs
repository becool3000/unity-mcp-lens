...
namespace Unity.AI.Assistant.Editor.Backend.Socket.Tools
{
    static class GetConsoleLogsTool
    {
        ...
        public static ConsoleLogsOutput GetConsoleLogs(
            ...
            [Parameter("Whether to exclude MCP, relay, and package self-noise from the output (default: true)")]
            bool excludeMcpNoise = true)
        {
            ...
            try
            {
                ...
                for (int i = startIndex; i < allLogs.Count; i++)
                {
                    ...
                    if (excludeMcpNoise && ConsoleNoiseFilter.ShouldExclude(logData.Message, logData.File))
                        continue;
