...
- Phase 17+ adds the first pass at those gaps: compact pack-transition summaries, clearer TSAM coverage summary data, uGUI canvas prefab preview/apply, scene prefab instantiate/bind preview/apply, UI raycast/layout verification, Game view layout matrix verification, scene serialized-reference verification, play-mode pointer/scroll smoke verification, and explicit play-mode exit.
