* [Unity AI Assistant](xref:assistant-intro)
   ...
   * [Generators integration with Assistant](xref:generator-assistant-landing)
      * [Asset creation in Assistant](xref:integration)
...
* [Integrate models and tools](xref:integration-landing)
   * [Model Context Protocol overview](xref:mcp-landing)
